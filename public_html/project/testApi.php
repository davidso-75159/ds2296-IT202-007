...
<div class="container-fluid">
    ...
    <p> Remember, we typically won't be frequently calling live data from our API, this is merely a quick sample. We'll want to cache data in our DB to save on API quota.
    </p>
    <form>
        <div>
            <label>Grand Prix</label>
            <input name="grandPrix" />
            <input type="submit" value="Fetch Race Info" />
        </div>
    </form>
    <div class="row">
        <?php
